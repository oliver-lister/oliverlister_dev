...
function ModalExitButton({ closeModal }: { closeModal: () => void }) {
  return (
    <Button
      id="modal-exit"
      onClick={closeModal}
      className="text-3xl select-none w-10 h-10 leading-none group flex items-center justify-center rounded-full transition active:scale-95 hover:bg-primary hover:dark:bg-secondary"
    >
